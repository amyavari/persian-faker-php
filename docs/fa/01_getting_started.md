...
- [اضافه کردن به پروژه](#اضافه-کردن-به-پروژه)
- [نحوه استفاده و فراخوانی](#نحوه-استفاده-و-فراخوانی)
- [توابع موجود](#توابع-موجود)
    - [توابع ایجاد اطلاعات یک شخص](#توابع-ایجاد-اطلاعات-یک-شخص)
    - [توابع ایجاد اطلاعات یک آدرس](#توابع-ایجاد-اطلاعات-یک-آدرس)
    - [توابع ایجاد شماره تلفن](#توابع-ایجاد-شماره-تلفن)
    - [اطلاعات شرکتی](#اطلاعات-شرکتی)
    - [توابع ایجاد متن تصادفی](#توابع-ایجاد-متن-تصادفی)
    - [اطلاعات بانکی](#اطلاعات-بانکی)
    - [رنگ](#رنگ)
    - [اینترنت](#اینترنت)
...
برای مشاهده داکیومنت کامل توابع اطلاعات مربوط به اینترنت لطفاً فایل [09-internet.md](09-internet.md) را ملاحظه نمائید.
